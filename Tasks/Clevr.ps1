...
$CSVGetFiles = @(
    @{ 
        MSSName = "Clevr-Staff.txt"
        VendorName = "LSKYClevrStaff.txt"
    },
    @{ 
        MSSName = "Clevr-Students.txt"
        VendorName = "LSKYClevrStudents.txt"
    },
    @{ 
        MSSName = "Clevr-StudentDemographics.txt"
        VendorName = "LSKYClevrStudentDemographics.txt"
    },
    @{ 
        MSSName = "Clevr-Locations.txt"
        VendorName = "clevrLocations.txt"
    }
)
